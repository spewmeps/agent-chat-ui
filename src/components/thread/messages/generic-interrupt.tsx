      ...
      <div className="border-b border-gray-200 bg-gray-50 px-4 py-3">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-medium text-gray-900">需要您确认/回复</h3>
          </div>
          <span className="text-xs text-gray-500">请查看下方信息并回复</span>
        </div>
      </div>
      <motion.div
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <tbody className="divide-y divide-gray-200">
                  {displayEntries.map((item, argIdx) => {
                    ...
                    return (
                      <tr key={argIdx}>
                        <td className="px-4 py-2 text-sm font-medium whitespace-nowrap text-gray-900 hidden">
                          {key === "instruction" ? "操作指引" : key}
                        </td>
